...
epl_17_18 <- detail_fb_data_for_all_matches(matches_urls = epl_17_18_urls, time_pause = 3)
...
epl_18_19 <- detail_fb_data_for_all_matches(matches_urls = epl_18_19_urls, time_pause = 3)
...
epl_19_20 <- detail_fb_data_for_all_matches(matches_urls = epl_19_20_urls, time_pause = 3)
...
epl_20_21 <- detail_fb_data_for_all_matches(matches_urls = epl_20_21_urls, time_pause = 3)
...
epl_21_22 <- detail_fb_data_for_all_matches(matches_urls = epl_21_22_urls, time_pause = 3)
...
epl_22_23 <- detail_fb_data_for_all_matches(matches_urls = epl_22_23_urls, time_pause = 3)
