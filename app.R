...
similar_pca_plot_3d <- 
  function(
    ...
    ###################################################################
  plot_ly(width = "100%", height = "100%") %>% 
      
    add_trace(
      data = all_play, 
      x = ~all_play[[X_AXIS_PC]], 
      y = ~all_play[[Y_AXIS_PC]], 
      z = ~all_play[[Z_AXIS_PC]],  
      color = ~league_name, 
      size = 3, 
      ...
      add_trace(
        ...
        x = ~selected[[X_AXIS_PC]], 
        y = ~selected[[Y_AXIS_PC]], 
        z = ~selected[[Z_AXIS_PC]],  
        
        name = PLAYER, 
        
        type = "scatter3d", 
        mode = "markers", 
        marker = list(size = 7, color = "purple"), 
        text = paste(
          'Name: ', selected$summary_player, 
          '<br>League: ', selected$league_name, 
          '<br>Team: ', selected$team_name 
      ...
      renderTable(
       ...
       output$pc_pick_3 <- 
            renderUI({
              ...
              selectInput(inputId = 'select_pc_plot_3', 
                           label = "Pick a PC for Z-axis", 
                           choices = colnames(data_from_pca())[grep("PC", colnames(data_from_pca()))], 
                           selected = colnames(data_from_pca())[grep("PC", colnames(data_from_pca()))][3])
          })
      ...
      output$similar_pca_plot_3d <- 
        renderPlotly(
          similar_pca_plot_3d(
              ...
              X_AXIS_PC = input$select_pc_plot_1, 
              Y_AXIS_PC = input$select_pc_plot_2, 
              Z_AXIS_PC = input$select_pc_plot_3
          )
        )
       ...
       output$pc_pick_2_3 <- 
            renderUI({
              ...
              selectInput(inputId = 'select_pc_plot_2_3', 
                           label = "Pick a PC for Y-axis", 
                           choices = colnames(data_from_pca_2())[grep("PC", colnames(data_from_pca_2()))], 
                           selected = colnames(data_from_pca_2())[grep("PC", colnames(data_from_pca_2()))][3])
          })
      ...
      output$similar_pca_plot_3d_2 <-
        renderPlotly(
          similar_pca_plot_3d(
              ...
              X_AXIS_PC = input$select_pc_plot_1_2, 
              Y_AXIS_PC = input$select_pc_plot_2_2, 
              Z_AXIS_PC = input$select_pc_plot_2_3
              )
        )
      ...
      output$similar_pca_table_3 <- 
       ...
       output$pc_pick_3_2 <- 
            renderUI({
              ...
              selectInput(inputId = 'select_pc_plot_3_2', 
                           label = "Pick a PC for Y-axis", 
                           choices = colnames(data_from_pca_3())[grep("PC", colnames(data_from_pca_3()))], 
       ...
       output$pc_pick_3_3 <- 
            renderUI({
              ...
              selectInput(inputId = 'select_pc_plot_3_3', 
                           label = "Pick a PC for Y-axis", 
                           choices = colnames(data_from_pca_3())[grep("PC", colnames(data_from_pca_3()))], 
                           selected = colnames(data_from_pca_3())[grep("PC", colnames(data_from_pca_3()))][3])
          })
      ...
      output$similar_pca_plot_3d_3 <-
        renderPlotly(
          similar_pca_plot_3d(
              ...
              X_AXIS_PC = input$select_pc_plot_1_3, 
              Y_AXIS_PC = input$select_pc_plot_3_2, 
              Z_AXIS_PC = input$select_pc_plot_3_3
              )
        )
                        ...
                        column(
                           ...
                           numericInput(inputId = 'target_sim_players', 
                                            ...
                                            tableOutput('similar_pca_table'), 
                                             ...
                                             uiOutput('pc_pick_3') %>% withSpinner(color="#0dc5c1")
                         ), 
                        column(
                          width = 9, 
                          dataTableOutput('similar_players_table') %>% withSpinner(color="#0dc5c1"),  
                           ...
                           plotlyOutput('similar_pca_plot_3d', height = "500px") %>% withSpinner(color="#0dc5c1")
                        )
                      )
                    ), 
                      ...
                      fluidPage(
                        ...
                        column(
                          ...
                          dataTableOutput('similar_players_table_2') %>% withSpinner(color="#0dc5c1"),  
                           ...
                           plotlyOutput('similar_pca_plot_3d_2', height = "500px") %>% withSpinner(color="#0dc5c1")
                        )
                      )
                    ),
                      ...
                      fluidPage(
                          ...
                          width = 3, 
                           numericInput(inputId = 'target_sim_players_3',
                                            ...
                                            tableOutput('similar_pca_table_3'), 
                                             ...
                                             uiOutput('pc_pick_3_2') %>% withSpinner(color="#0dc5c1"), 
                                             uiOutput('pc_pick_3_3') %>% withSpinner(color="#0dc5c1")
                        ...
                        column(
                          ...
                          dataTableOutput('similar_players_table_3') %>% withSpinner(color="#0dc5c1"),  
                           ...
                           plotlyOutput('similar_pca_plot_3d_3', height = "1000px") %>% withSpinner(color="#0dc5c1")
                        )
                      )
                    )
                  )       
