...
lib_22 <- detail_fb_data_for_all_matches(matches_urls = urls_22, time_pause = 3)
...
lib_21 <- detail_fb_data_for_all_matches(matches_urls = urls_21, time_pause = 3)
...
lib_20 <- detail_fb_data_for_all_matches(matches_urls = urls_20, time_pause = 3)
...
lib_19 <- detail_fb_data_for_all_matches(matches_urls = urls_19, time_pause = 3)
